...
#for showing signup/login button for admin(by (tino))
...
#for showing signup/login button for doctor(by (tino))
...
#for showing signup/login button for patient(by (tino))
...
#-----------for checking user is doctor , patient or admin(by (tino))
def is_admin(user):
...
#Developed By : Tinotenda Biningu
#facebook : fb.com/tino.biningu
